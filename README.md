...
Just stuff specific to that hardware.
...
home folder has Home-Manager configs, such as my retroarch and noctalia. For using noctalia on my laptop, I've just copied the folder over and made edits as I've needed (adding battery indicator etc)
